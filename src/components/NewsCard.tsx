...
const NewsCard: React.FC<NewsCardProps> = ({ article }) => {
  ...
  return (
    ...
    >
      <div className="flex flex-col max-w-xs h-[470px] bg-gray-400 rounded-[4%] overflow-hidden shadow-sm border-2 border-transparent hover:border-secondary hover:shadow-md transition-all">
