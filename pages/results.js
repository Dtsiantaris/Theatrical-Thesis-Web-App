    ...
    <>
      ...
      <div className="pageWrapper">
        <div className="pageContent">
          ...
          >
            <Configure hitsPerPage={hitsPerPage} page={page - 1} />
            <VirtualSearchBox />
              ...
              <div className={classes.hitsContainer}>
                <Index indexName="Artists">
                  ...
                  {artistsHits > 5 && !router.query.sm && (
                    <Link
                      href={`/results?search_query=${router.query.search_query}&sm=a`}
                    >
                      Περισσότερα Αποτελέσματα Καλλιτεχνών
                    </Link>
                  )}
                </Index>
              </div>
              ...
              <div className={classes.hitsContainer}>
                <Index indexName="Venues">
                  ...
                  {venuesHits > 5 && !router.query.sm && (
                    <Link
                      href={`/results?search_query=${router.query.search_query}&sm=v`}
                    >
                      Περισσότερα Αποτελέσματα Θεατρικών Χώρων
                    </Link>
                  )}
                </Index>
              </div>
              ...
              <div className={classes.hitsContainer}>
                <Index indexName="Productions">
                  ...
                  {productionsHits > 5 && !router.query.sm && (
                    <Link
                      href={`/results?search_query=${router.query.search_query}&sm=p`}
                    >
                      Περισσότερα Αποτελέσματα Παραστάσεων
                    </Link>
                  )}
                </Index>
              </div>
            ...
            <CustomStateResults
              setArtistsHits={setArtistsHits}
              setProductionsHits={setProductionsHits}
              setVenuesHits={setVenuesHits}
              ...
              <TableRow key={hit.objectID} className={classes.tableRow}>
                <TableCell>
                  <Link href={`/${path}/${hit.ID}`}>
                    {path === "artists" ? hit.Fullname : hit.Title}
                  </Link>
                </TableCell>
              </TableRow>
            ))}
